...
<section class="content">
    ...
    @csrf
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('komisi') is-invalid @enderror" name="komisi" id="komisi" value="{{ old('komisi') }}" placeholder="Masukkan Komisi">
                            
                                <!-- error message untuk komisi -->
                                @error('komisi')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group">
                            <label for="komisi_nominal">Komisi Nominal</label>
                            <input type="text" class="form-control @error('komisi_nominal') is-invalid @enderror" name="komisi_nominal" id="komisi_nominal" value="{{ old('komisi_nominal') }}" placeholder="Masukkan Komisi Nominal">
                            
                                <!-- error message untuk komisi_nominal -->
                                @error('komisi_nominal')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                                @enderror
        ...
        <div class="row">
            ...
            <input type="submit" value="Create Sales" class="btn btn-success float-right">
            </div>
        </div>
    </form>
</section>
