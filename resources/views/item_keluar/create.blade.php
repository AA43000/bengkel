...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Daftar Item Keluar Add</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Daftar Item Keluar Add</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <form id="formall" action="{{ route('item_keluar.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" value="Auto">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('total_qty') is-invalid @enderror" name="total_qty" id="total_qty" value="{{ old('total_qty') }}" readonly>
        ...
        <div class="col-md-12">
            ...
            @csrf
            <input type="hidden" name="idthitemkeluar" id="idthitemkeluar" value="0">
    ...
    <div class="row">
        ...
        <input type="button" onclick="$('#formall').submit()" value="Create Item Keluar" class="btn btn-success float-right">
        </div>
    </div>
</section>
...
<script type="text/javascript">
    ...
    function delete_detail(idtdpembelian) {
        ...
        if(next) {
            $.ajax({
                url: '/item_keluar/delete_detail/'+idtdpembelian,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    load_detail();
    ...
    function edit_detail(idtdpembelian) {
        $.ajax({
            url: '/item_keluar/edit_detail/'+idtdpembelian,
            type: 'GET',
            dataType: 'json',
            success: function(data) {
