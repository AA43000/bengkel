        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Penjualan Edit</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('tpenjualan.update', $thpenjualan->id) }}" method="POST" enctype="multipart/form-data" id="formall">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" value="{{ $thpenjualan->kode }}" readonly>
                                    ...
                                    <label for="id_pelanggan">Pelanggan</label>
                                        <div class="input-group">
                                            <select id="id_pelanggan" name="id_pelanggan" class="form-control select2 @error('id_pelanggan') is-invalid @enderror">
                                                ...
                                                <option value="{{ $pelanggan->id }}" {{ $thpenjualan->id_pelanggan == $pelanggan->id ? 'selected' : '' }}>{{ $pelanggan->kode.' - '.$pelanggan->nama }}</option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="pembayaran" id="pembayaran" class="form-control">
                                        <option value="Cash" {{ $thpenjualan->pembayaran == 'Cash' ? 'selected' : '' }}>Cash</option>
                                        <option value="Transfer" {{ $thpenjualan->pembayaran == 'Transfer' ? 'selected' : '' }}>Transfer</option>
                                        <option value="Kredit" {{ $thpenjualan->pembayaran == 'Kredit' ? 'selected' : '' }}>Kredit</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('total_akhir') is-invalid @enderror" name="total_akhir" id="total_akhir" value="{{ old('total_akhir', $thpenjualan->total_akhir) }}" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('total_bayar') is-invalid @enderror" name="total_bayar" id="total_bayar" value="{{ old('total_bayar', $thpenjualan->total_bayar) }}" onkeyup="get_kembalian()">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('kembalian') is-invalid @enderror" name="kembalian" id="kembalian" value="{{ old('kembalian', $thpenjualan->kembalian) }}" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" id="tanggal" value="{{ old('tanggal', $thpenjualan->tanggal) }}">
        ...
        <div class="col-md-12">
            ...
            @csrf
            <input type="hidden" name="idthpenjualan" id="idthpenjualan" value="{{ $thpenjualan->id }}">
    ...
    <div class="row">
        ...
        <input type="button" onclick="$('#formall').submit()" value="Update Penjualan" class="btn btn-success float-right">
        </div>
    </div>
