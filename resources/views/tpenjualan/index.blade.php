            ...
            <table class="table table-striped projects">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $thpenjualan->kode_pelanggan.' - '.$thpenjualan->nama_pelanggan }}</td>
                        <td>{{ $thpenjualan->total }}</td>
                        <td>{{ $thpenjualan->potongan }}</td>
    ...
    function get_detail(idthpenjualan) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#total").html(data.thpenjualan.total);
                $("#potongan").html(data.thpenjualan.potongan);
