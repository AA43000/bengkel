...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Tukar Tambah Edit</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Tukar Tambah Edit</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('tukartambah.update', $thtukartambah->id) }}" method="POST" enctype="multipart/form-data" id="formall">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" id="kode" value="{{ old('kode', $thtukartambah->kode) }}" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="id_pelanggan" name="id_pelanggan" class="form-control custom-select @error('id_pelanggan') is-invalid @enderror">
                                        ...
                                        <option value="{{ $pelanggan->id }}" {{ $thtukartambah->id_pelanggan == $pelanggan->id ? "selected" : "" }}>{{ $pelanggan->kode.' - '.$pelanggan->nama }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('total') is-invalid @enderror" name="total" id="total_akhir" value="{{ old('total', $thtukartambah->total) }}" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" id="tanggal" value="{{ old('tanggal', $thtukartambah->tanggal) }}">
        ...
        <div class="col-md-12">
            ...
            @csrf
            <input type="hidden" name="idthtukartambah" id="idthtukartambah" value="{{ $thtukartambah->id }}">
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <input type="number" class="form-control" name="harga" id="harga" value="0" onkeyup="get_total_detail()" required>
                                                </th>
                                                <th>
    ...
    <div class="row">
        ...
        <input type="button" onclick="$('#formall').submit()" value="Update Tukar Tambah" class="btn btn-success float-right">
        </div>
    </div>
